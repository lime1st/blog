package backend.study.blog.config.oauth;
...
import backend.study.blog.util.CookieUtil;
...
public class OAuth2SuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
    ...
    private void addRefreshTokenToCookie(HttpServletRequest request,
        ...
        CookieUtil.addCooke(response, REFRESH_TOKEN_COOKIE_NAME, refreshToken, cookieMaxAge);
    }
